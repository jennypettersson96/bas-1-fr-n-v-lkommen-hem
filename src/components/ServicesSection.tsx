...
const ServicesSection = () => (
  <section id="tjanster" className="scroll-mt-16 bg-secondary/60 py-14 sm:py-16 lg:py-20">
    <div className="container">
      <h2 className="font-display text-3xl italic font-medium tracking-tight text-foreground sm:text-4xl">Tjänster</h2>
        ...
        {services.map((s, i) => (
          <Card key={i} className="h-full border-border/70 bg-card shadow-sm">
            <CardHeader className="space-y-2 p-5 sm:p-6">
              <CardTitle className="font-display text-xl italic font-medium sm:text-2xl">{s.title}</CardTitle>
